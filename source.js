const panels = { panel1: null, panel2: null } //id of the data for each panel
...
window.onload = () => {
    ...
    //get the integers passed as parameters
    let p1 = parseInt(u.get("panel1"))
    let p2 = parseInt(u.get("panel2"))

    //check if they're valid, if they're null return -1
    panels.panel1 = p1 === 0 ? 0 : p1 || -1;
    panels.panel2 = p2 === 0 ? 0 : p2 || -1;
